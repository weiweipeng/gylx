    ...
    export default{
        ...
        methods: {
				...
				getdata:function(p,r){
					...
					console.log(parms);
					this.$http.post(that.$httpUrl.getCatCourselist,parms).then(function(res){
						if(!that.hide){
		                  that.hide = true;
		                  setTimeout(function () {
		                    that.isClear = false;
	         	...
	         	collect(index,type,id,act){
	         		...
	         		this.$http.post(this.$httpUrl.doCourseCollect,obj).then((res)=>{
	         			console.log(res)
	         		},(err)=>{
	         			console.log(err)
	         		})
	         	...
	         	actives(index,type,id,act1){
	         		...
	         		this.$http.post(this.$httpUrl.doCourseLike,obj1).then((res)=>{
	         			console.log(res)
	         		},(err)=>{
	         			console.log(err)
	         		})
