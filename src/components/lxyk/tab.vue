					    ...
					    <ul class="section">
					        <li class="section1"  v-for='list in lists'>
					            ...
					            <div class="tab_right">
					                ...
					                <p class="btn_sub" @tap="jumpgo(list.AppointmentId)">提交反馈</p>
					            </div>
		            ...
		            <li class="section1 "  v-for='list in listss'>
		                ...
		                <div class="tab_right">
		                    ...
		                    <p class="status">
		                     <img src="../../assets/images/ioncfontlogo/status.png">
		                       <span>预约状态:</span>
		                       <span v-if="list.Status == 0 ">已报名</span>
		                       <span v-if="list.Status == 1 ">已取消</span>
		                       <span v-if="list.Status == 2 ">已受理</span>
		                       <span v-if="list.Status == 3 ">不通过</span>
		                    </p>
		                    ...
		                    <p class="btn_sub" @tap="jumpgo2(list.AppointmentId)">提交反馈</p>
		                </div>
   ...
   import loadings from '../base/loading/loading.vue'
    export default{
       ...
       components: {
         ...
         methods:{
         	jumpgo(id){
         		this.$router.push("/FeedbackForm?cid="+id);
         	},
         	jumpgo2(id){
         		this.$router.push("/feedbackcompany?cid="+id);
         	},
         	getdata:function(p,r,s){	
         		var that =this;
         		...
         		var param={
         		 ...
         		 this.$http.post(this.$httpUrl.getFeedBackList,param)
         		 .then((res) => {
...
//       		 	 console.log(3333);
	          		...
	          		if(s){
			              ...
			              s.endPullDownToRefresh(); //refresh completed
			                  ...
			                  s.endPullUpToRefresh(true);
			              	  ...
			              	  that.listss=that.listss.concat(res.data.data);
         	...
         	getdata1:function(p,r,s){
         		...
         		console.log(s);
         		this.$http.post(this.$httpUrl.getPersonalFeedBackList,param).then(function(res){
                   if(!that.hide){
		                  that.hide = true;
		                  setTimeout(function () {
		                    that.isClear = false;
		              ...
		              callback: function() {
							...
							setTimeout(function() {
								if(index==0){
									console.log(self);
									that.p=1;
									that.getdata1(1,10,self);
								}else if(index==1){
									that.p1=1;
									that.getdata(1,10,self);
								}
							}, 1000);
						}
		            },
		            up: {
		              ...
		              callback: function() {
							...
							setTimeout(function() {
								if(index==0){
									that.p++;
									that.getdata1(that.p,10,self);
								}else if(index==1){
									that.p1++;
									that.getdata(that.p1,10,self);
								}
							}, 1000);
						}
		            }
